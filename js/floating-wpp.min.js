(function (b) {
  b.fn.floatingWhatsApp = function (r) {
    ...
    e.addClass("floating-wpp-button")
      .append(b(j.buttonImage))
      .css({
        width: j.size,
        height: j.size,
    ...
    if (j.showPopup) {
      ...
      if (j.avatar) {
        let $avatarInfo =
          '<div class="floating-wpp-avatar-info"><div class="floating-wpp-avatar-name">' +
          j.avatarName +
          '</div><div class="floating-wpp-avatar-role">' +
          j.avatarRole +
          "</div></div>";
        f.append(
          '<img src="' +
          ...
          $avatarInfo,
          l
        ).css("background-color", j.headerColor);
      } else {
        f.append("<span>" + j.headerTitle + "</span>", l).css(
          "background-color",
          j.headerColor
        );
      }
    ...
    function k() {
      ...
      s += p ? "api" : "web";
      s +=
        ".whatsapp.com/send?phone=" + j.phone + "&text=" + encodeURI(j.message);
      window.open(s);
    }
  };
  function c() {
